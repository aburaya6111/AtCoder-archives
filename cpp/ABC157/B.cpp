...
void Main() {
    ...
    int ans = 0;
    chmin(ans, A[0][0] + A[0][1] + A[0][2]);
    chmin(ans, A[1][0] + A[1][1] + A[1][2]);
    chmin(ans, A[2][0] + A[2][1] + A[2][2]);

    chmin(ans, A[0][0] + A[1][0] + A[2][0]);

    chmin(ans, A[0][1] + A[1][1] + A[2][1]);
    chmin(ans, A[0][2] + A[1][2] + A[2][2]);

    chmin(ans, A[0][0] + A[1][1] + A[2][2]);
    chmin(ans, A[0][2] + A[1][1] + A[2][0]);
